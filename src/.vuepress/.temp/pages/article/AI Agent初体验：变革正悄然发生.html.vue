<template><div><h1 id="ai-agent初体验-变革正悄然发生" tabindex="-1"><a class="header-anchor" href="#ai-agent初体验-变革正悄然发生"><span>AI Agent初体验：变革正悄然发生</span></a></h1>
<blockquote>
<p><strong>阅读本文收获</strong>：<br>
① 了解大模型、智能体相关基本概念</p>
<p>② 智能体应用场景：</p>
<ul>
<li><strong>搜索智能体</strong>：技术调研好搭子；</li>
<li><strong>问答智能体</strong>：基于本地知识库打造问答机器人，提供信息协助解决问题；</li>
<li><strong>编程智能体</strong>：动嘴不动手，不写一行代码实现功能。</li>
</ul>
</blockquote>
...
<h2 id="相关概念" tabindex="-1"><a class="header-anchor" href="#相关概念"><span>相关概念</span></a></h2>
<h3 id="大模型-large-language-model" tabindex="-1"><a class="header-anchor" href="#大模型-large-language-model"><span>大模型（Large Language Model）</span></a></h3>
...
<div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre v-pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>GPT-4参数约1.76T</span></span>
...
<h3 id="智能体-ai-agent" tabindex="-1"><a class="header-anchor" href="#智能体-ai-agent"><span>智能体（AI Agent）</span></a></h3>
...
<h3 id="搜索智能体" tabindex="-1"><a class="header-anchor" href="#搜索智能体"><span>搜索智能体</span></a></h3>
<p>顾名思义，就是能够帮你自动检索并总结相关内容的智能体。如果你不擅长信息检索，苦于找不到技术问题或方案的解决思路，那么它可以成为你获取信息的第一步。</p>
<p>易用性：⭐️⭐️⭐️⭐️⭐️</p>
<h4 id="中文-kimi-探索版" tabindex="-1"><a class="header-anchor" href="#中文-kimi-探索版"><span>中文：<a href="https://kimi.moonshot.cn/" target="_blank" rel="noopener noreferrer">Kimi 探索版</a></span></a></h4>
...
<h4 id="英文-storm" tabindex="-1"><a class="header-anchor" href="#英文-storm"><span>英文：<a href="https://storm.genie.stanford.edu/" target="_blank" rel="noopener noreferrer">Storm</a></span></a></h4>
...
<h3 id="问答智能体" tabindex="-1"><a class="header-anchor" href="#问答智能体"><span>问答智能体</span></a></h3>
<p>这里特指<strong>私有知识库问答智能体</strong>，能在理解相关资料的前提下总结核心知识点，并基于已有知识给出回答。</p>
<p>易用性：⭐️⭐️⭐️⭐️</p>
<p>底层核心技术包括<strong>提示词和RAG</strong>。提示词的好坏对结果的生成质量影响很大。</p>
<div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre v-pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>一个优秀的 Prompt = 角色 + 场景 + 任务 + 输出要求</span></span></code></pre>
...
<h4 id="ollama-anythingllm搭建本地知识库" tabindex="-1"><a class="header-anchor" href="#ollama-anythingllm搭建本地知识库"><span>Ollama+AnythingLLM搭建本地知识库</span></a></h4>
...
<h3 id="编程智能体" tabindex="-1"><a class="header-anchor" href="#编程智能体"><span>编程智能体</span></a></h3>
...
<h4 id="cline-开源编程智能体插件" tabindex="-1"><a class="header-anchor" href="#cline-开源编程智能体插件"><span><a href="https://github.com/cline/cline" target="_blank" rel="noopener noreferrer">Cline：开源编程智能体插件</a></span></a></h4>
...
<h4 id="cursor-超火的ai代码编辑器" tabindex="-1"><a class="header-anchor" href="#cursor-超火的ai代码编辑器"><span><a href="https://www.cursor.com/" target="_blank" rel="noopener noreferrer">Cursor：超火的AI代码编辑器</a></span></a></h4>
