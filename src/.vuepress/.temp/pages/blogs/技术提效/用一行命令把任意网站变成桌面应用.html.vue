<template><div><h1 id="用一行命令把任意网站变成桌面应用" tabindex="-1"><a class="header-anchor" href="#用一行命令把任意网站变成桌面应用"><span>用一行命令把任意网站变成桌面应用</span></a></h1>
...
<h2 id="pwa很好-但不通用" tabindex="-1"><a class="header-anchor" href="#pwa很好-但不通用"><span>PWA很好，但不通用</span></a></h2>
...
<h2 id="将任意网页变为桌面应用" tabindex="-1"><a class="header-anchor" href="#将任意网页变为桌面应用"><span>将任意网页变为桌面应用</span></a></h2>
...
<h3 id="常用包下载" tabindex="-1"><a class="header-anchor" href="#常用包下载"><span>常用包下载</span></a></h3>
...
<h3 id="命令行一键打包" tabindex="-1"><a class="header-anchor" href="#命令行一键打包"><span>命令行一键打包</span></a></h3>
...
<h3 id="定制开发" tabindex="-1"><a class="header-anchor" href="#定制开发"><span>定制开发</span></a></h3>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="原理浅析" tabindex="-1"><a class="header-anchor" href="#原理浅析"><span>原理浅析</span></a></h3>
